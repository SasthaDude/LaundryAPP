...
class WashingLeadsDetails extends StatefulWidget {
  const WashingLeadsDetails({super.key});

  @override
  State<WashingLeadsDetails> createState() => _WashingLeadsDetailsState();
}

class _WashingLeadsDetailsState extends State<WashingLeadsDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Washing Leads'),
      ),
      body: Stack(
        children: [
