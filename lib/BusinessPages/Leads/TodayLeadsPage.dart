...
class TodayLeadsDetails extends StatefulWidget {
  const TodayLeadsDetails({super.key});

  @override
  State<TodayLeadsDetails> createState() => _TodayLeadsDetailsState();
}

class _TodayLeadsDetailsState extends State<TodayLeadsDetails> {
