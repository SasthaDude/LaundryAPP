...
class DryCleaningLeadsDetails extends StatefulWidget {
  const DryCleaningLeadsDetails({super.key});

  @override
  State<DryCleaningLeadsDetails> createState() => _DryCleaningLeadsDetailsState();
}

class _DryCleaningLeadsDetailsState extends State<DryCleaningLeadsDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('DryCleaning Leads'),
      ),
      body: Stack(
        children: [
