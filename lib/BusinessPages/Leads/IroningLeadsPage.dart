...
class IroningLeadsDetails extends StatefulWidget {
  const IroningLeadsDetails({super.key});

  @override
  State<IroningLeadsDetails> createState() => _IroningLeadsDetailsState();
}

class _IroningLeadsDetailsState extends State<IroningLeadsDetails> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Ironing Leads'),
      ),
      body: Stack(
        children: [
