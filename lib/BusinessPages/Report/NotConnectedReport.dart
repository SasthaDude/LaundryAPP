...
class NotConnectedDetails extends StatefulWidget {
  const NotConnectedDetails({super.key});

  @override
  State<NotConnectedDetails> createState() => _NotConnectedDetailsState();
}

class _NotConnectedDetailsState extends State<NotConnectedDetails> {
  ...
  void _initializeEntries() {
    for (int i = 0; i < _entryCount; i++) {
      ...
      _statuses.add('Not Connected'); // Set default status
