...
class UnableToConnectDetails extends StatefulWidget {
  const UnableToConnectDetails({super.key});

  @override
  State<UnableToConnectDetails> createState() => _UnableToConnectDetailsState();
}

class _UnableToConnectDetailsState extends State<UnableToConnectDetails> {
  ...
  void _initializeEntries() {
    for (int i = 0; i < _entryCount; i++) {
      ...
      _statuses.add('Unable to Connect'); // Set default status
