...
class ConnectedSaleDetails extends StatefulWidget {
  const ConnectedSaleDetails({super.key});

  @override
  State<ConnectedSaleDetails> createState() => _ConnectedSaleDetailsState();
}

class _ConnectedSaleDetailsState extends State<ConnectedSaleDetails> {
  ...
  void _initializeEntries() {
    for (int i = 0; i < _entryCount; i++) {
      ...
      _statuses.add('Connected/Sale'); // Set default status
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Connected/Sale'),
      ),
      body: Stack(
        children: [
